...
....
plantuml::partial$diagrams/28-submodel-element.puml[]
....
...
....
plantuml::partial$diagrams/29-relationship-element.puml[]
....
...
....
plantuml::partial$diagrams/30-basic-event-element.puml[]
....
...
....
plantuml::partial$diagrams/31-event-payload.puml[]
....
...
....
plantuml::partial$diagrams/32-blob.puml[]
....
...
....
plantuml::partial$diagrams/33-capability.puml[]
....
...
....
plantuml::partial$diagrams/34-data-element.puml[]
....
...
Data elements include properties, file handling, and reference elements, see Figure 33.
...
....
plantuml::partial$diagrams/35-entity.puml[]
....
...
....
plantuml::partial$diagrams/36-event-element.puml[]
....
...
....
plantuml::partial$diagrams/37-file.puml[]
....
...
....
plantuml::partial$diagrams/38-multi-language-property.puml[]
....
...
....
plantuml::partial$diagrams/39-operation.puml[]
....
...
====
Note 1: operations typically specify the behavior of a component in terms of procedures.
Hence, operations enable the specification of services with procedure-based interactions xref:bibliography.adoc#bib23[[23\]].
====
...
....
plantuml::partial$diagrams/40-property.puml[]
....
...
....
plantuml::partial$diagrams/41-range.puml[]
....
...
....
plantuml::partial$diagrams/42-reference-element.puml[]
....
...
....
plantuml::partial$diagrams/43-relationship-element.puml[]
....
...
....
plantuml::partial$diagrams/44-submodel-element-collection.puml[]
....


Submodel Element Collections are used for complex elements with a typically fixed set of properties with unique names.
This set of properties is typically predefined by the semantic definition (referenced via _semanticId_) of the submodel element collection.
Each property within the collection itself should have clearly defined semantics.

====
Note: the different elements of a submodel element collection do not have to have different __semanticId__s.
However, in these cases the usage of a _SubmodelElementList_ should be considered.
====
...
....
plantuml::partial$diagrams/45-submodel-element-list.puml[]
....
...
In case of complex values in the array, a _SubmodelElementCollection_ would be used as values in the leaf lists.

Similarly, a table with three columns can be represented.
In this case a _SubmodelElementCollection_ with three _SubmodelElementLists_ would be contained and the _semanticId_ as well as the _semanticIdListElement_ for the three columns would differ.
