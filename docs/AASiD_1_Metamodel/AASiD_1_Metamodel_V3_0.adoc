image:media/media/image1.png[media/media/image1]
...
image:media/media/image54.png[media/media/image54,width=137,height=478]Table 9 depicts example values and the value range of the different data type"
