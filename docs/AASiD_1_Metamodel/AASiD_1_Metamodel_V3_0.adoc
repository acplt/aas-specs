...
===== Has Data Specification Attributesimage:media/media/image15.png[media/media/image15,width=176,height=80]
...
===== image:media/media/image19.png[media/media/image19,width=408,height=258]Identifiable Attributes
...
[#_Toc126252231 .anchor]##image:media/media/image20.png[media/media/image20,width=418,height=148]Figure 19 Metamodel of Qualifiables
...
===== image:media/media/image21.png[media/media/image21,width=385,height=148]Qualifier Attributes
...
===== image:media/media/image23.png[media/media/image23,width=222,height=151]Referable Attributes
...
==== image:media/media/image24.png[media/media/image24,width=530,height=324]Asset Administration Shell Attributes
...
==== image:media/media/image25.png[media/media/image25,width=442,height=242]Asset Information Attributes
...
==== image:media/media/image26.png[media/media/image26,width=470,height=139]Submodel Attributes
...
==== image:media/media/image27.png[media/media/image27,width=207,height=139]Submodel Element Attributes
...
===== image:media/media/image29.png[media/media/image29,width=200,height=177]Annotated Relationship Element Attributes
...
===== image:media/media/image30.png[media/media/image30,width=378,height=232]Basic Event Element Attributes
...
image:media/media/image31.png[media/media/image31,width=226,height=173]Note: the payload is not part of the information model as exchanged via the AASX package format but used in re-active Asset Administration Shells.
...
===== image:media/media/image32.png[media/media/image32,width=146,height=93] Blob Attributes
...
===== image:media/media/image33.png[media/media/image33,width=113,height=80]Capability Attributes
...
===== image:media/media/image34.png[media/media/image34,width=623,height=235]Data Element and Overview of Data Element Types
...
===== Entity Attributesimage:media/media/image35.png[media/media/image35,width=376,height=120]
...
===== Event Attributesimage:media/media/image36.png[media/media/image36,width=168,height=82]
...
===== image:media/media/image37.png[media/media/image37,width=146,height=93] File Attributes
...
image:media/media/image38.png[media/media/image38,width=207,height=93]Figure 37 Metamodel of Multi Language Properties
...
[#_Toc126252250 .anchor]##image:media/media/image39.png[media/media/image39,width=375,height=106]Figure 38 Metamodel of Operations
...
===== image:media/media/image40.png[media/media/image40,width=186,height=106]Property Attributes
...
[#_Toc126252252 .anchor]##image:media/media/image41.png[media/media/image41,width=167,height=117]Figure 40 Metamodel of Ranges
...
===== image:media/media/image42.png[media/media/image42,width=146,height=95]Reference Element Attributes
...
===== image:media/media/image43.png[media/media/image43,width=132,height=93]Relationship Element Attributes
...
===== image:media/media/image44.png[media/media/image44,width=182,height=228]Submodel Element Collection Attributes
...
===== image:media/media/image45.png[media/media/image45,width=259,height=314]Submodel Element List Attributes
...
==== image:media/media/image46.png[media/media/image46,width=186,height=92]Concept Description Attributes
...
==== image:media/media/image47.png[media/media/image47,width=547,height=227]Environment Attributes
...
===== image:media/media/image48.png[media/media/image48,width=358,height=207] Reference Attributes
...
[#_Ref103183599 .anchor]##image:media/media/image50.png[media/media/image50,width=623,height=542]Figure 49 Logical Model for Keys of References (non-normative)

[#_Toc126252262 .anchor]##image:media/media/image51.png[media/media/image51,width=164,height=398]Figure 50 Metamodel of KeyTypes Enumeration
...
==== image:media/media/image57.png[media/media/image57,width=259,height=208]Data Specification Template Attributes
...
[#_Ref36937253 .anchor]##image:media/media/image69.png[media/media/image69,width=200,height=80]Figure 69 Aggregation

image:media/media/image70.png[media/media/image70,width=163,height=80]Figure 70 illustrates that the attribute notation can be used for an association end owned by a class. In this example, the attribute name is "attr" and the elements of this attribute are typed with _Class2._ The multiplicity, here "0..*", is added in square brackets. If the aggregation is ordered, it is added in curly brackets like in this example.

[#_Ref37000883 .anchor]####Figure 70 Navigable Attribute Notation for Associations

image:media/media/image71.png[media/media/image71,width=91,height=80]Figure 71 shows a class with three attributes with primitive types and default values. When a property with a default value is instantiated in the absence of a specific setting for the property, the default value is evaluated to provide the initial values of the property.

[#_Ref66219196 .anchor]####Figure 71 Default Value

image:media/media/image72.png[media/media/image72,width=206,height=80]Figure 72 shows that there is a dependency relationship between _Class1_ and _Class2_. In this case, the dependency means that _Class1_ depends on _Class2_ because the type of attribute _attr_ depends on the specification of class _Class2._ A dependency is depicted as dashed arrow between two model elements.

[#_Ref36937918 .anchor]####Figure 72 Dependency

image:media/media/image73.png[media/media/image73,width=86,height=80]Figure 73 shows an abstract class. It uses the stereotype <<abstract>>. There are no instances of abstract classes. They are typically used for specific member elements that are inherited by non-abstract classes.
...
[#_Ref36938237 .anchor]##image:media/media/image74.png[media/media/image74,width=106,height=80]Figure 74 Package

image:media/media/image75.png[media/media/image75,width=256,height=86]Figure 75 shows that all elements in _Package2_ are imported into the namespace defined by _Package1_. This is a special dependency relationship between the two packages with stereotype <<import>>.

[#_Ref36938632 .anchor]####Figure 75 Imported Package

image:media/media/image76.png[media/media/image76,width=119,height=93] Figure 76 shows an enumeration with the name "Enumeration1". An enumeration is a data type with its values enumerated as literals. It contains two literal values, "a" and "b". It is a class with stereotype <<enumeration>>. The literals owned by the enumeration are ordered.
...
image:media/media/image77.png[media/media/image77,width=86,height=73]Figure 77 shows the definition of the data type with the name "DataType1". A data type has instances that are identified only by their value. It is a class with stereotype <<dataType>>.

[#_Ref36940247 .anchor]####Figure 77 Data Type

image:media/media/image78.png[media/media/image78,width=86,height=73]Figure 78 shows a primitive data type with the name "int". Primitive data types are predefined data types, without any substructure. The primitive data types are defined outside UML.
...
[#_Ref36995742 .anchor]##image:media/media/image79.png[media/media/image79,width=200,height=80]Figure 79 Note

image:media/media/image80.png[media/media/image80,width=213,height=80]Figure 80 shows how a constraint is attached to an element, in this example to class "Class1".
...
[#_Ref36999936 .anchor]##image:media/media/image81.png[media/media/image81,width=410,height=205]Figure 81 Graphical Representations of Composite Aggregation/Composition
...
[#_Ref37015321 .anchor]##image:media/media/image83.png[media/media/image83,width=386,height=206]Figure 83 Graphical Representation of Generalization/Inheritance
...
image:media/media/image84.png[media/media/image84,width=339,height=160]Note 2: in this specification all elements of an enumeration are ordered alphabetically.
...
[#_Ref120119373 .anchor]##image:media/media/image88.png[media/media/image88,width=595,height=522]Figure 88 Extract From Metamodel for Composite I4.0 Components
