...
image:media/media/image4.emf[media/media/image4,width=560,height=204]
...
image:media/media/image5.emf[media/media/image5,width=623,height=386]
...
image:media/media/image9.jpeg[media/media/image9,width=642,height=369][#_Ref117710770 .anchor]####Figure 8 Tracking of Changes via Events
...
image:media/media/image10.jpeg[media/media/image10,width=642,height=309][#_Ref128495005 .anchor]####Figure 9 Value Push Events Across Clouds
...
image:media/media/image11.emf[media/media/image11,width=623,height=673]
...
image:media/media/image12.emf[media/media/image12,width=547,height=227]

[#_Ref128496917 .anchor]####Figure 11 Metamodel of Environment

image:media/media/image13.emf[media/media/image13,width=623,height=455]
...
image:media/media/image14.emf[media/media/image14,width=155,height=120]
...
image:media/media/image16.emf[media/media/image16,width=502,height=260]
...
image:media/media/image17.emf[media/media/image17,width=336,height=104]
...
image:media/media/image18.emf[media/media/image18,width=232,height=93]
...
[#_Toc126252231 .anchor]##image:media/media/image20.emf[media/media/image20,width=418,height=148]Figure 19 Metamodel of Qualifiables
...
image:media/media/image28.emf[media/media/image28,width=623,height=236]
...
image:media/media/image31.emf[media/media/image31,width=226,height=173]Note: the payload is not part of the information model as exchanged via the AASX package format but used in re-active Asset Administration Shells.
...
image:media/media/image38.emf[media/media/image38,width=207,height=93]Figure 37 Metamodel of Multi Language Properties
...
[#_Toc126252250 .anchor]##image:media/media/image39.emf[media/media/image39,width=375,height=106]Figure 38 Metamodel of Operations
...
[#_Toc126252252 .anchor]##image:media/media/image41.emf[media/media/image41,width=167,height=117]Figure 40 Metamodel of Ranges
...
image:media/media/image49.emf[media/media/image49,width=338,height=398]
...
[#_Ref103183599 .anchor]##image:media/media/image50.emf[media/media/image50,width=623,height=542]Figure 49 Logical Model for Keys of References (non-normative)

[#_Toc126252262 .anchor]##image:media/media/image51.emf[media/media/image51,width=164,height=398]Figure 50 Metamodel of KeyTypes Enumeration
...
image:media/media/image52.emf[media/media/image52,width=162,height=304]
...
image:media/media/image53.emf[media/media/image53,width=110,height=91]

[#_Toc126252264 .anchor]####Figure 52 DefTypeDefRdf Enumeration

The enumeration is derived from Figure 54.

image:media/media/image54.emf[media/media/image54,width=137,height=478]Table 9 depicts example values and the value range of the different data types. The left column "Data Type"
...
{empty}[#_Toc126252266 .anchor]##image:media/media/image55.png[media/media/image55,width=642,height=714]Figure 54 Built-In Types of XML Schema Definition 1.0 (XSD)footnote:[Source: https://www.w3.org/TR/xmlschema-2/#built-in-primitive-datatypes]
...
image:media/media/image56.emf[media/media/image56,width=550,height=398]
...
image:media/media/image59.emf[media/media/image59,width=623,height=383]
...
[#_Ref36937253 .anchor]##image:media/media/image69.emf[media/media/image69,width=200,height=80]Figure 69 Aggregation

image:media/media/image70.emf[media/media/image70,width=163,height=80]Figure 70 illustrates that the attribute notation can be used for an association end owned by a class. In this example, the attribute name is "attr" and the elements of this attribute are typed with _Class2._ The multiplicity, here "0..*", is added in square brackets. If the aggregation is ordered, it is added in curly brackets like in this example.

[#_Ref37000883 .anchor]####Figure 70 Navigable Attribute Notation for Associations

image:media/media/image71.emf[media/media/image71,width=91,height=80]Figure 71 shows a class with three attributes with primitive types and default values. When a property with a default value is instantiated in the absence of a specific setting for the property, the default value is evaluated to provide the initial values of the property.

[#_Ref66219196 .anchor]####Figure 71 Default Value

image:media/media/image72.emf[media/media/image72,width=206,height=80]Figure 72 shows that there is a dependency relationship between _Class1_ and _Class2_. In this case, the dependency means that _Class1_ depends on _Class2_ because the type of attribute _attr_ depends on the specification of class _Class2._ A dependency is depicted as dashed arrow between two model elements.

[#_Ref36937918 .anchor]####Figure 72 Dependency

image:media/media/image73.emf[media/media/image73,width=86,height=80]Figure 73 shows an abstract class. It uses the stereotype <<abstract>>. There are no instances of abstract classes. They are typically used for specific member elements that are inherited by non-abstract classes.
...
[#_Ref36938237 .anchor]##image:media/media/image74.emf[media/media/image74,width=106,height=80]Figure 74 Package

image:media/media/image75.emf[media/media/image75,width=256,height=86]Figure 75 shows that all elements in _Package2_ are imported into the namespace defined by _Package1_. This is a special dependency relationship between the two packages with stereotype <<import>>.

[#_Ref36938632 .anchor]####Figure 75 Imported Package

image:media/media/image76.emf[media/media/image76,width=119,height=93] Figure 76 shows an enumeration with the name "Enumeration1". An enumeration is a data type with its values enumerated as literals. It contains two literal values, "a" and "b". It is a class with stereotype <<enumeration>>. The literals owned by the enumeration are ordered.
...
image:media/media/image77.emf[media/media/image77,width=86,height=73]Figure 77 shows the definition of the data type with the name "DataType1". A data type has instances that are identified only by their value. It is a class with stereotype <<dataType>>.

[#_Ref36940247 .anchor]####Figure 77 Data Type

image:media/media/image78.emf[media/media/image78,width=86,height=73]Figure 78 shows a primitive data type with the name "int". Primitive data types are predefined data types, without any substructure. The primitive data types are defined outside UML.
...
[#_Ref36995742 .anchor]##image:media/media/image79.emf[media/media/image79,width=200,height=80]Figure 79 Note

image:media/media/image80.emf[media/media/image80,width=213,height=80]Figure 80 shows how a constraint is attached to an element, in this example to class "Class1".
...
[#_Ref36999936 .anchor]##image:media/media/image81.emf[media/media/image81,width=410,height=205]Figure 81 Graphical Representations of Composite Aggregation/Composition
...
[#_Ref37015321 .anchor]##image:media/media/image83.emf[media/media/image83,width=386,height=206]Figure 83 Graphical Representation of Generalization/Inheritance
...
image:media/media/image84.emf[media/media/image84,width=339,height=160]Note 2: in this specification all elements of an enumeration are ordered alphabetically.

[#_Ref127802962 .anchor]####Figure 84 Graphical Representation for Enumeration with Inheritance

image:media/media/image85.png[Ein Bild, das Text enthält. Automatisch generierte Beschreibung,width=119,height=96]Figure 85 shows an experimental class, marked by the stereotype "Experimental”.
...
image:media/media/image86.png[Ein Bild, das Text enthält. Automatisch generierte Beschreibung,width=123,height=99]Figure 87 shows a class representing a template. It is marked by the stereotype "Template".

[#_Ref127803009 .anchor]##image:media/media/image87.png[Ein Bild, das Text enthält. Automatisch generierte Beschreibung,width=120,height=97]Figure 86 Graphical Representation for Deprecated Elements
...
[#_Ref120119373 .anchor]##image:media/media/image88.emf[media/media/image88,width=595,height=522]Figure 88 Extract From Metamodel for Composite I4.0 Components
