...
* [SOURCE: xref:https://eclass.eu/support/technical-specification/data-model/conceptual-data-model[ECLASS] footnote:[In IEC61360:2017, this refers to a "term" of a value list]]
...
* [SOURCE: xref:https://eclass.eu/support/technical-specification/data-model/conceptual-data-model[ECLASS]]
...
* *IRI* – IRI (xref:https://tools.ietf.org/html/rfc3987[RFC 3987]) or URI and URL according to xref:https://tools.ietf.org/html/rfc3986[RFC 3986] as identification of assets, Administration Shells and other (probably not standardized, but globally unique) properties and classifications.

The following is also permitted:

* *Custom* – internal custom identifiers such as UUIDs/GUIDs (xref:https://en.wikipedia.org/wiki/Universally_unique_identifier[universally unique identifiers]/globally unique identifiers), which a manufacturer can use for all sorts of in-house purposes within the Administration Shell.
...
The definition of xref:https://www.w3.org/TR/xmlschema-2/#terminology[XML Schema] is used for matching
...
====
Note: for any string conformant to xref:https://datatracker.ietf.org/doc/html/rfc8089[RFC8089], the "file" URI scheme (for relative and absolute file paths) applies.
====
...
"life cycle qual" (as specified in IEC 61360-7 - IEC/SC 3D - Common Data Dictionary (xref:https://cdd.iec.ch/cdd/common/iec61360-7.nsf/SearchFrameset?OpenFrameSet[CDD - V2.0015.0004])
...
image:image54.png[width=137,height=478]
...
image:image82.png[width=397,height=224]
