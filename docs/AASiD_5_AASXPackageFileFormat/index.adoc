...
image:media/media/image8.png[extracted-media/media/image8,width=642,height=300]
...
image:media/media/image9.png[extracted-media/media/image9,width=622,height=272]
...
image:media/media/image10.png[Ein Bild, das Text enthält. Automatisch generierte Beschreibung,width=377,height=299]
