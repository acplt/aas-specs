...
* link:AASiD/AASiD_1_Metamodel/index.html[Specification of the Asset Administration Shell. Part 1: Metamodel]
* link:AASiD/AASiD_2_API/index.html[Specification of the Asset Administration Shell. Part 2: Application Programming Interfaces]
* link:AASiD/AASiD_5_AASXPackageFileFormat/index.html[Specification of the Asset Administration Shell. Part 5: Package File Format (AASX)]
...
* link:AASiD/AAS_Classes/index.html[Classes/Types in AAS Metamodel]
